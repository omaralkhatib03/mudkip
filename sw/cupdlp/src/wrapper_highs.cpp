...
extern "C" void *postsolvedModel_highs(
  ...
  assert(solution_org.col_value.size() ==  (size_t) nCols_org);
  assert(solution_org.col_dual.size() ==   (size_t) nCols_org);
  assert(solution_org.row_value.size() ==  (size_t) nRows_org);
  assert(solution_org.row_dual.size() ==   (size_t) nRows_org);
