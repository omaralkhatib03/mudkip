...
#
# Script generated by Vivado on Sat Feb 08 20:34:35 GMT 2025
# SW Build 5266912 on Sun Dec 15 09:03:31 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fp_add_s.sh
...
#
# Usage        : fp_add_s.sh
#                fp_add_s.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_add_s.sh [-reset_run]
#                fp_add_s.sh [-reset_log]
#                fp_add_s.sh [-help]
#
...
#                script (type 'fp_add_s.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname xbip_utils_v3_0_14 -libname axi_utils_v2_0_10 -libname xbip_pipe_v3_0_10 -libname xbip_dsp48_wrapper_v3_0_6 -libname mult_gen_v12_0_22 -libname floating_point_v7_1_19 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_6 mult_gen_v12_0_22 floating_point_v7_1_19 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fp_add_s.sh - Script generated by export_simulation (Vivado v2024.2.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_add_s.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_add_s xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_add_s -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/omar/Documents/year-4/FYP/mudkip/vivado/mudkip.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_add_s_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fp_add_s.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fp_add_s.sh [-help]\n\
Usage: fp_add_s.sh [-step]\n\
Usage: fp_add_s.sh [-lib_map_path]\n\
Usage: fp_add_s.sh [-reset_run]\n\
Usage: fp_add_s.sh [-reset_log]\n\
Usage: fp_add_s.sh [-keep_index]\n\
Usage: fp_add_s.sh [-noclean_files]\n\n\
