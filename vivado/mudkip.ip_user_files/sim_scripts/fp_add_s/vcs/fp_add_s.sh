...
design_libs=(xpm xbip_utils_v3_0_14 axi_utils_v2_0_10 xbip_pipe_v3_0_10 xbip_dsp48_wrapper_v3_0_6 mult_gen_v12_0_22 floating_point_v7_1_19 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_add_s xil_defaultlib.glbl -o fp_add_s_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_add_s_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/omar/Documents/year-4/FYP/mudkip/vivado/mudkip.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key fp_add_s_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp_add_s_simv.daidir vcs_lib c.obj)
