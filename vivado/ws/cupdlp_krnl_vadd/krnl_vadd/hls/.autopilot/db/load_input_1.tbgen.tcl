...
set Spec2ImplPortList { 
	...
	in2_stream { ap_fifo {  { in2_stream_din fifo_data_in 1 32 }  { in2_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { in2_stream_fifo_cap fifo_update 0 3 }  { in2_stream_full_n fifo_status 0 1 }  { in2_stream_write fifo_port_we 1 1 } } }
}
