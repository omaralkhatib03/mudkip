	...
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "gmem0", "Type" : "MAXI", "Direction" : "O",
				...
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_result_Pipeline_mem_wr_fu_73", "Port" : "gmem0", "Inst_start_state" : "2", "Inst_end_state" : "3"}]},
			...
			{"Name" : "out_stream", "Type" : "Fifo", "Direction" : "I", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_store_result_Pipeline_mem_wr_fu_73", "Port" : "out_stream", "Inst_start_state" : "2", "Inst_end_state" : "3"}]}]},
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "4174", "Max" : "4174"}
]}
...
set Spec2ImplPortList { 
	...
	out_stream { ap_fifo {  { out_stream_dout fifo_data_in 0 32 }  { out_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { out_stream_fifo_cap fifo_update 0 3 }  { out_stream_empty_n fifo_status 0 1 }  { out_stream_read fifo_port_we 1 1 } } }
}
