set SynModuleInfo {
  ...
  {SRCNAME load_input.1 MODELNAME load_input_1 RTLNAME krnl_vadd_load_input_1
    SUBMODULES {
      {MODELNAME krnl_vadd_flow_control_loop_pipe RTLNAME krnl_vadd_flow_control_loop_pipe BINDTYPE interface TYPE internal_upc_flow_control INSTNAME krnl_vadd_flow_control_loop_pipe_U}
    }
  }
  ...
  {SRCNAME krnl_vadd MODELNAME krnl_vadd RTLNAME krnl_vadd IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME krnl_vadd_fifo_w32_d2_S RTLNAME krnl_vadd_fifo_w32_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME size_c1_U}
