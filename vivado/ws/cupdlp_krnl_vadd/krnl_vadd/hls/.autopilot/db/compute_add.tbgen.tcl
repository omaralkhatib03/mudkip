...
set portList { 
	...
	{ in1_stream_num_data_valid sc_in sc_lv 3 signal 2 } 
	{ in1_stream_fifo_cap sc_in sc_lv 3 signal 2 } 
	...
	{ in2_stream_num_data_valid sc_in sc_lv 3 signal 3 } 
	{ in2_stream_fifo_cap sc_in sc_lv 3 signal 3 } 
	...
	{ out_stream_num_data_valid sc_in sc_lv 3 signal 4 } 
	{ out_stream_fifo_cap sc_in sc_lv 3 signal 4 } 
...
set Spec2ImplPortList { 
	...
	in1_stream { ap_fifo {  { in1_stream_dout fifo_data_in 0 32 }  { in1_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { in1_stream_fifo_cap fifo_update 0 3 }  { in1_stream_empty_n fifo_status 0 1 }  { in1_stream_read fifo_port_we 1 1 } } }
	in2_stream { ap_fifo {  { in2_stream_dout fifo_data_in 0 32 }  { in2_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { in2_stream_fifo_cap fifo_update 0 3 }  { in2_stream_empty_n fifo_status 0 1 }  { in2_stream_read fifo_port_we 1 1 } } }
	out_stream { ap_fifo {  { out_stream_din fifo_data_in 1 32 }  { out_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { out_stream_fifo_cap fifo_update 0 3 }  { out_stream_full_n fifo_status 0 1 }  { out_stream_write fifo_port_we 1 1 } } }
}
