...
reg    out_r_blk_n;
reg    size_blk_n;
reg   [31:0] size_read_reg_131;
reg    ap_block_state1;
wire  signed [61:0] trunc_ln114_1_fu_97_p4;
reg   [61:0] trunc_ln114_1_reg_136;
...
wire  signed [63:0] sext_ln114_fu_107_p1;
wire   [63:0] zext_ln114_fu_126_p1;
reg    size_read_local;
reg    out_r_read_local;
wire   [0:0] icmp_ln114_fu_87_p2;
wire   [30:0] trunc_ln114_fu_93_p1;
wire   [30:0] empty_fu_118_p3;
reg   [76:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state77) & (m_axi_gmem0_BVALID == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((~((1'b1 == ap_block_state1) | (m_axi_gmem0_AWREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        size_read_reg_131 <= size_dout;
        trunc_ln114_1_reg_136 <= {{out_r_dout[63:2]}};
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_block_state1) | (m_axi_gmem0_AWREADY == 1'b0))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state77) & (m_axi_gmem0_BVALID == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if ((~((1'b1 == ap_block_state1) | (m_axi_gmem0_AWREADY == 1'b0)) & (1'b1 == ap_CS_fsm_state1))) begin
        m_axi_gmem0_AWLEN = zext_ln114_fu_126_p1;
    end else if (((1'b1 == ap_CS_fsm_state3) | (1'b1 == ap_CS_fsm_state2))) begin
        m_axi_gmem0_AWLEN = grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN;
    end else begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_state3 : begin
            if (((grp_store_result_Pipeline_mem_wr_fu_73_ap_done == 1'b1) & (1'b1 == ap_CS_fsm_state3))) begin
...
assign empty_fu_118_p3 = ((icmp_ln114_fu_87_p2[0:0] == 1'b1) ? trunc_ln114_fu_93_p1 : 31'd0);
...
assign sext_ln114_fu_107_p1 = trunc_ln114_1_fu_97_p4;

assign size_read = size_read_local;

assign trunc_ln114_1_fu_97_p4 = {{out_r_dout[63:2]}};

assign trunc_ln114_fu_93_p1 = size_dout[30:0];

assign zext_ln114_fu_126_p1 = empty_fu_118_p3;
