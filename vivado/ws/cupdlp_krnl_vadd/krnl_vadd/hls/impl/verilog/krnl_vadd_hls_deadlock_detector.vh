...
always @(negedge dl_reset or posedge dl_clock) begin
    ...
    assign proc_1_data_FIFO_blk[0] = 1'b0 | (~load_input_U0.size_c1_blk_n) | (~load_input_U0.grp_load_input_Pipeline_mem_rd_fu_82.in1_stream_blk_n);
    ...
    assign proc_2_data_FIFO_blk[0] = 1'b0 | (~load_input_1_U0.in2_stream_blk_n);
