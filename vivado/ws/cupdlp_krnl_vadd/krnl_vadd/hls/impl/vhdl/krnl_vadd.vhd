...
architecture behav of krnl_vadd is 
    ...
    "krnl_vadd_krnl_vadd,hls_ip_2024_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvc1902-vsva2197-2MP-e-S,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=3.650000,HLS_SYN_LAT=4249,HLS_SYN_TPT=4175,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=5535,HLS_SYN_LUT=7336,HLS_VERSION=2024_1}";
...
attribute shreg_extract of ap_rst_n_inv : signal is "no";
    ...
    signal load_input_U0_size_c1_din : STD_LOGIC_VECTOR (31 downto 0);
    signal load_input_U0_size_c1_write : STD_LOGIC;
    ...
    signal in1_stream_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal in1_stream_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    signal in1_stream_empty_n : STD_LOGIC;
    signal in2_stream_full_n : STD_LOGIC;
    signal in2_stream_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal in2_stream_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal in2_stream_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
    ...
    signal out_stream_num_data_valid : STD_LOGIC_VECTOR (2 downto 0);
    signal out_stream_fifo_cap : STD_LOGIC_VECTOR (2 downto 0);
...
begin
    ...
    port map (
        ...
        ARESET => ap_rst_n_inv,
        ACLK_EN => ap_const_logic_1,
        I_CH0_ARVALID => load_input_U0_m_axi_gmem0_ARVALID,
        I_CH0_ARREADY => gmem0_ARREADY,
        I_CH0_ARADDR => load_input_U0_m_axi_gmem0_ARADDR,
        I_CH0_ARLEN => load_input_U0_m_axi_gmem0_ARLEN,
        I_CH0_RVALID => gmem0_RVALID,
        I_CH0_RREADY => load_input_U0_m_axi_gmem0_RREADY,
        I_CH0_RDATA => gmem0_RDATA,
        I_CH0_RFIFONUM => gmem0_RFIFONUM,
        I_CH0_AWVALID => store_result_U0_m_axi_gmem0_AWVALID,
        I_CH0_AWREADY => gmem0_AWREADY,
        I_CH0_AWADDR => store_result_U0_m_axi_gmem0_AWADDR,
        I_CH0_AWLEN => store_result_U0_m_axi_gmem0_AWLEN,
        I_CH0_WVALID => store_result_U0_m_axi_gmem0_WVALID,
        I_CH0_WREADY => gmem0_WREADY,
        I_CH0_WDATA => store_result_U0_m_axi_gmem0_WDATA,
        I_CH0_WSTRB => store_result_U0_m_axi_gmem0_WSTRB,
        I_CH0_BVALID => gmem0_BVALID,
        I_CH0_BREADY => store_result_U0_m_axi_gmem0_BREADY);
    ...
    port map (
        ...
        ARESET => ap_rst_n_inv,
        ACLK_EN => ap_const_logic_1,
        I_CH0_ARVALID => load_input_1_U0_m_axi_gmem1_ARVALID,
        I_CH0_ARREADY => gmem1_ARREADY,
        I_CH0_ARADDR => load_input_1_U0_m_axi_gmem1_ARADDR,
        I_CH0_ARLEN => load_input_1_U0_m_axi_gmem1_ARLEN,
        I_CH0_RVALID => gmem1_RVALID,
        I_CH0_RREADY => load_input_1_U0_m_axi_gmem1_RREADY,
    ...
    size_c1_U : component krnl_vadd_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => load_input_U0_size_c1_din,
        if_full_n => size_c1_full_n,
        if_write => load_input_U0_size_c1_write,
