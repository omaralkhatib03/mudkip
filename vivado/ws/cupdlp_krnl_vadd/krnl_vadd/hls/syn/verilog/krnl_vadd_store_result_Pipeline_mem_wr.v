...
reg   [30:0] i_fu_54;
wire   [30:0] add_ln114_fu_121_p2;
wire    ap_loop_init;
reg   [30:0] ap_sig_allocacmp_i_load;
reg    out_stream_read_local;
wire   [31:0] zext_ln114_fu_111_p1;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (icmp_ln114_fu_115_p2 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln114_fu_115_p2 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        out_stream_read_local = 1'b1;
    end else begin
        out_stream_read_local = 1'b0;
    end
end
...
assign add_ln114_fu_121_p2 = (ap_sig_allocacmp_i_load + 31'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((m_axi_gmem0_WREADY == 1'b0) | (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & ((m_axi_gmem0_WREADY == 1'b0) | (1'b1 == ap_block_state2_pp0_stage0_iter1)));
end
...
assign icmp_ln114_fu_115_p2 = (($signed(zext_ln114_fu_111_p1) < $signed(size_load)) ? 1'b1 : 1'b0);
...
assign m_axi_gmem0_WDATA = out_stream_dout;
...
assign out_stream_read = out_stream_read_local;

assign zext_ln114_fu_111_p1 = ap_sig_allocacmp_i_load;
