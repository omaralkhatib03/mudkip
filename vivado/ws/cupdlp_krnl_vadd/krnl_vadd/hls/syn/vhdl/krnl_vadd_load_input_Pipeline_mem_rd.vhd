...
attribute shreg_extract : string;
    ...
    signal icmp_ln93_fu_111_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln93_fu_117_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_block_pp0_stage0_01001 : BOOLEAN;
    signal in1_stream_write_local : STD_LOGIC;
    signal zext_ln93_fu_107_p1 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (icmp_ln93_fu_111_p2 = ap_const_lv1_1))) then 
                    i_fu_52 <= add_ln93_fu_117_p2;
    ...
    add_ln93_fu_117_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(m_axi_gmem0_RVALID, in1_stream_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((in1_stream_full_n = ap_const_logic_0) or (m_axi_gmem0_RVALID = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln93_fu_111_p2)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln93_fu_111_p2 = ap_const_lv1_0))) then 
    ...
    icmp_ln93_fu_111_p2 <= "1" when (signed(zext_ln93_fu_107_p1) < signed(size)) else "0";

    in1_stream_blk_n_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, in1_stream_full_n, ap_block_pp0_stage0)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    in1_stream_din <= m_axi_gmem0_RDATA;
    in1_stream_write <= in1_stream_write_local;

    in1_stream_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            in1_stream_write_local <= ap_const_logic_1;
        else 
            in1_stream_write_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    zext_ln93_fu_107_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(ap_sig_allocacmp_i_load),32));
end behav;
