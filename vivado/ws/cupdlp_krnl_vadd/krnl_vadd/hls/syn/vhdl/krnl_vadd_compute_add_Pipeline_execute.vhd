...
attribute shreg_extract : string;
    ...
    signal icmp_ln106_fu_93_p2 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal add_ln106_fu_99_p2 : STD_LOGIC_VECTOR (30 downto 0);
    signal ap_loop_init : STD_LOGIC;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal ap_sig_allocacmp_i_load : STD_LOGIC_VECTOR (30 downto 0);
    signal in1_stream_read_local : STD_LOGIC;
    signal in2_stream_read_local : STD_LOGIC;
    signal add_ln108_fu_121_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if (((icmp_ln106_fu_93_p2 = ap_const_lv1_1) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1))) then 
    ...
    add_ln106_fu_99_p2 <= std_logic_vector(unsigned(ap_sig_allocacmp_i_load) + unsigned(ap_const_lv31_1));
    add_ln108_fu_121_p2 <= std_logic_vector(unsigned(in2_stream_dout) + unsigned(in1_stream_dout));
    ...
    ap_block_state2_pp0_stage0_iter1_assign_proc : process(in1_stream_empty_n, in2_stream_empty_n, out_stream_full_n)
    begin
                ap_block_state2_pp0_stage0_iter1 <= ((out_stream_full_n = ap_const_logic_0) or (in2_stream_empty_n = ap_const_logic_0) or (in1_stream_empty_n = ap_const_logic_0));
    end process;


    ap_condition_exit_pp0_iter0_stage0_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, icmp_ln106_fu_93_p2)
    begin
        if (((icmp_ln106_fu_93_p2 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_subdone) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
    ...
    icmp_ln106_fu_93_p2 <= "1" when (signed(i_cast_fu_89_p1) < signed(size_load)) else "0";
    ...
    in1_stream_read <= in1_stream_read_local;

    in1_stream_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            in1_stream_read_local <= ap_const_logic_1;
        else 
            in1_stream_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    in2_stream_read <= in2_stream_read_local;

    in2_stream_read_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
            in2_stream_read_local <= ap_const_logic_1;
        else 
            in2_stream_read_local <= ap_const_logic_0;
        end if; 
    end process;
    ...
    out_stream_din <= add_ln108_fu_121_p2;
    out_stream_write <= out_stream_write_local;

    out_stream_write_local_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then 
