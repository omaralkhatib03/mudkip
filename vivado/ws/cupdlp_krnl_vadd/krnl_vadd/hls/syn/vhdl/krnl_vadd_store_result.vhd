...
attribute shreg_extract : string;
    ...
    signal size_read_reg_131 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal trunc_ln114_1_fu_97_p4 : STD_LOGIC_VECTOR (61 downto 0);
    signal trunc_ln114_1_reg_136 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    signal sext_ln114_fu_107_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal zext_ln114_fu_126_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal size_read_local : STD_LOGIC;
    signal out_r_read_local : STD_LOGIC;
    signal icmp_ln114_fu_87_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln114_fu_93_p1 : STD_LOGIC_VECTOR (30 downto 0);
...
begin
    ...
    port map (
        ...
        out_stream_num_data_valid => ap_const_lv3_0,
        out_stream_fifo_cap => ap_const_lv3_0,
        ...
        size_load => size_read_reg_131,
        sext_ln114 => trunc_ln114_1_reg_136,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((ap_const_logic_1 = ap_CS_fsm_state77) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                size_read_reg_131 <= size_dout;
                trunc_ln114_1_reg_136 <= out_r_dout(63 downto 2);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_CS_fsm, ap_CS_fsm_state1, m_axi_gmem0_AWREADY, m_axi_gmem0_BVALID, ap_CS_fsm_state77, ap_block_state1, grp_store_result_Pipeline_mem_wr_fu_73_ap_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((grp_store_result_Pipeline_mem_wr_fu_73_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state3))) then
            ...
            when ap_ST_fsm_state77 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state77) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state77;
                end if;
    ...
    ap_ST_fsm_state1_blk_assign_proc : process(m_axi_gmem0_AWREADY, ap_block_state1)
    begin
        if (((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) then 
    ...
    ap_ST_fsm_state3_blk_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_ap_done)
    begin
    ...
    ap_ST_fsm_state77_blk_assign_proc : process(m_axi_gmem0_BVALID)
    begin
    ...
    ap_done_assign_proc : process(ap_done_reg, m_axi_gmem0_BVALID, ap_CS_fsm_state77)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state77) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(m_axi_gmem0_BVALID, ap_CS_fsm_state77)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state77) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    empty_fu_118_p3 <= 
        trunc_ln114_fu_93_p1 when (icmp_ln114_fu_87_p2(0) = '1') else 
        ap_const_lv31_0;

    gmem0_blk_n_AW_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, m_axi_gmem0_AWREADY)
    begin
    ...
    gmem0_blk_n_B_assign_proc : process(m_axi_gmem0_BVALID, ap_CS_fsm_state77)
    begin
    ...
    m_axi_gmem0_AWADDR_assign_proc : process(ap_CS_fsm_state1, m_axi_gmem0_AWREADY, ap_block_state1, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWADDR, ap_CS_fsm_state2, ap_CS_fsm_state3, sext_ln114_fu_107_p1)
    begin
        if ((not(((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m_axi_gmem0_AWADDR <= sext_ln114_fu_107_p1;
    ...
    m_axi_gmem0_AWBURST_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWBURST, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
    ...
    m_axi_gmem0_AWCACHE_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWCACHE, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWCACHE <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWCACHE;
        else 
    ...
    m_axi_gmem0_AWID_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWID <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWID;
        else 
    ...
    m_axi_gmem0_AWLEN_assign_proc : process(ap_CS_fsm_state1, m_axi_gmem0_AWREADY, ap_block_state1, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN, ap_CS_fsm_state2, ap_CS_fsm_state3, zext_ln114_fu_126_p1)
    begin
        if ((not(((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            m_axi_gmem0_AWLEN <= zext_ln114_fu_126_p1(32 - 1 downto 0);
        elsif (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWLEN <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLEN;
        else 
    ...
    m_axi_gmem0_AWLOCK_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLOCK, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWLOCK <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWLOCK;
        else 
    ...
    m_axi_gmem0_AWPROT_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWPROT, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWPROT <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWPROT;
        else 
    ...
    m_axi_gmem0_AWQOS_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWQOS, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWQOS <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWQOS;
        else 
    ...
    m_axi_gmem0_AWREGION_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWREGION, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWREGION <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWREGION;
        else 
    ...
    m_axi_gmem0_AWSIZE_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWSIZE, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWSIZE <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWSIZE;
        else 
    ...
    m_axi_gmem0_AWUSER_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWUSER, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_AWUSER <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWUSER;
        else 
    ...
    m_axi_gmem0_AWVALID_assign_proc : process(ap_CS_fsm_state1, m_axi_gmem0_AWREADY, ap_block_state1, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_AWVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if ((not(((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    m_axi_gmem0_BREADY_assign_proc : process(m_axi_gmem0_BVALID, ap_CS_fsm_state77, grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_BREADY, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state77) and (m_axi_gmem0_BVALID = ap_const_logic_1))) then 
    ...
    m_axi_gmem0_WVALID_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WVALID, ap_CS_fsm_state2, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) or (ap_const_logic_1 = ap_CS_fsm_state2))) then 
            m_axi_gmem0_WVALID <= grp_store_result_Pipeline_mem_wr_fu_73_m_axi_gmem0_WVALID;
        else 
    ...
    out_r_read_local_assign_proc : process(ap_CS_fsm_state1, m_axi_gmem0_AWREADY, ap_block_state1)
    begin
        if ((not(((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    out_stream_read_assign_proc : process(grp_store_result_Pipeline_mem_wr_fu_73_out_stream_read, ap_CS_fsm_state3)
    begin
        ...
        sext_ln114_fu_107_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln114_1_fu_97_p4),64));
    ...
    size_read_local_assign_proc : process(ap_CS_fsm_state1, m_axi_gmem0_AWREADY, ap_block_state1)
    begin
        if ((not(((ap_const_boolean_1 = ap_block_state1) or (m_axi_gmem0_AWREADY = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    trunc_ln114_1_fu_97_p4 <= out_r_dout(63 downto 2);
    trunc_ln114_fu_93_p1 <= size_dout(31 - 1 downto 0);
    zext_ln114_fu_126_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(empty_fu_118_p3),64));
end behav;
