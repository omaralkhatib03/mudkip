...
HD_PWD='/home/omar/Documents/year-4/FYP/mudkip/vivado/mudkip.runs/top_fl_vadd_top_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_fl_vadd_top_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_fl_vadd_top_0_1.tcl
