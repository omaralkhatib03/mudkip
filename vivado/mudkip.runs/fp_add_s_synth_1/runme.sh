...
HD_PWD='/home/omar/Documents/year-4/FYP/mudkip/vivado/mudkip.runs/fp_add_s_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fp_add_s.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fp_add_s.tcl
