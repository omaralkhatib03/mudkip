...
//
//**********************************************************************
#ifndef _bd_d0e7_S03_AXI_nmu_0_core_h_
#define _bd_d0e7_S03_AXI_nmu_0_core_h_

#include "NOCMasterUnitXtlm.h"
#include "properties.h"

class bd_d0e7_S03_AXI_nmu_0_core : public NOCMasterUnitXtlm
{
public:
...
bd_d0e7_S03_AXI_nmu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_d0e7_S03_AXI_nmu_0_core() = default;
