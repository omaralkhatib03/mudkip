...
cupdlp_float twoNormSquared(cupdlp_float *x, cupdlp_int n) { return pow(twoNorm(x, n), 2); }
...
cupdlp_float dot(cupdlp_int n, const cupdlp_float *x, cupdlp_int incx, const cupdlp_float *y,
           cupdlp_int incy) {
#ifdef USE_MY_BLAS
